...
cmd({
    ...
    try {
        ...
        const { data: commitData } = await axios.get("https://api.github.com/repos/JawadTech3/KHAN-MD/commits/main");
        ...
        const { data: zipData } = await axios.get("https://github.com/JawadTech3/KHAN-MD/archive/main.zip", { responseType: "arraybuffer" });

...
cmd({
    ...
    try {
        ...
        const { data: commitData } = await axios.get("https://api.github.com/repos/JawadXDev/KHAN-MD/commits/main");
        ...
        const { data: zipData } = await axios.get("https://github.com/JawadXDev/KHAN-MD/archive/main.zip", { responseType: "arraybuffer" });
